      ...
      <div className="order-2 min-w-0 space-y-5">
        ...
        <section className="overflow-hidden rounded-[28px] border border-slate-200 bg-white shadow-sm" aria-labelledby="rain-radar-title">
          ...
          <div className="relative aspect-[4/3] min-h-[340px] w-full bg-slate-100 sm:aspect-[16/9] sm:min-h-[420px]">
            <iframe title={`${displayLocation}の雨雲レーダー`} src={`https://www.rainviewer.com/map.html?c=1&layer=radar&lm=0&loc=${selectedLatitude},${selectedLongitude},8&o=83&oAP=1&oC=0&oCS=1&oF=0&oFa=0&oU=0&rmt=2&sm=1&sn=1`} loading="lazy" className="absolute inset-0 h-full w-full border-0" allowFullScreen/>
          </div>
