  ...
  return <main className="min-h-screen bg-[#f3f7fb] text-[#13233b]">
    ...
    <div className="mx-auto grid w-full max-w-[1680px] gap-5 p-3 sm:p-4 md:p-8 xl:grid-cols-[minmax(520px,620px)_minmax(0,1fr)]">
      ...
      <div className="order-2 flex min-w-0 flex-col gap-5">
        ...
        <section className="order-4 rounded-[28px] border border-slate-200 bg-white p-4 shadow-sm md:p-6"><div className="flex items-start justify-between gap-3"><div><p className="text-xs font-bold text-blue-600">NEXT 24 HOURS</p><h2 className="text-xl font-black">更新時刻から先の24時間</h2><p className="mt-1 text-sm text-slate-500">{displayLocation}・まず雨の時間帯を確認、下で1時間ごとの詳細を確認できます</p></div><CloudRain className="mt-1 text-blue-500" size={25}/></div>
